...
| **This work (GaitGuard)** — metrics from `docs/paper/results.md` | 2026 | 260 | 8 cohorts; pathology-tier multiclass screening | 4 IMUs; sensor ablation reported | Primary 2-method ensemble (IF + OCSVM latent, rank-averaged): ROC-AUC **0.7545**, PR-AUC **0.8669**, F1 **0.786**, MCC **0.388**, Sens. **0.711**, Spec. **0.720** | Internal LOSO on one public dataset; no prospective fall-outcome validation |
