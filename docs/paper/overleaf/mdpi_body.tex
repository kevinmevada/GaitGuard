% MDPI Sensors body paste-in
% 1. Download official MDPI LaTeX template (mdpi.com/authors/latex)
% 2. Set: \documentclass[sensors,article,submit,pdftex,moreauthors]{Definitions/mdpi}
% 3. Put abstract/keywords into MDPI \abstract{...} / \keyword{...} (see main.tex abstract)
% 4. Paste everything below into the template body (after front matter)
